...
class TtReservationCustomer(models.Model):
    _name = 'tt.reservation.passenger.labpintar'
    _inherit = 'tt.reservation.passenger'
    _description = 'Reservation Passenger Lab Pintar'

    cost_service_charge_ids = fields.Many2many('tt.service.charge','tt_reservation_labpintar_cost_charge_rel', 'passenger_id', 'service_charge_id', 'Cost Service Charges')

    channel_service_charge_ids = fields.Many2many('tt.service.charge','tt_reservation_labpintar_channel_charge_rel', 'passenger_id', 'service_charge_id', 'Channel Service Charges')
