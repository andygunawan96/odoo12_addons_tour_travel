...
ACC_TRANSPORT_TYPE = {
    ...
    'tt.reservation.periksain': 'Periksain',
    'tt.reservation.phc': 'PHC',
    'tt.refund': 'Refund',
    'tt.reschedule': 'Airline Reschedule',
    'tt.reschedule.periksain': 'Periksain Reschedule',
    'tt.reschedule.phc': 'PHC Reschedule',
...
ACC_TRANSPORT_TYPE_REVERSE = {
    ...
    'Periksain': 'tt.reservation.periksain',
    'PHC': 'tt.reservation.phc',
    'Refund': 'tt.refund',
    'Airline Reschedule': 'tt.reschedule',
    'Periksain Reschedule': 'tt.reschedule.periksain',
    'PHC Reschedule': 'tt.reschedule.phc',
...
CABIN_CLASS = [
    ('Y', 'Economy - Airline'),
    ('W', 'Premium Economy - Airline'),
    ('C','Business Class - Airline'),
    ('F','First Class - Airline'),
    ('E', 'Executive Class - Train'),
    ('K','Economy Class - Train'),
    ('B','Business Class - Train')
]
