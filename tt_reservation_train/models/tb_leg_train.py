...
class TransportLeg(models.Model):
    ...
    segment_id = fields.Many2one('tt.tb.segment.train', 'Segment', ondelete='cascade')
    booking_id = fields.Many2one('tt.reservation.train', 'Order Number', related='segment_id.booking_id', store=True)
