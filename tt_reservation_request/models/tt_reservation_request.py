...
class TtReservationRequest(models.Model):
    ...
    ho_id = fields.Many2one('tt.agent', 'Head Office', domain=_get_ho_id_domain, required=False, default=lambda self: self.env.user.ho_id, readonly=True, states={'draft': [('readonly', False)]})
