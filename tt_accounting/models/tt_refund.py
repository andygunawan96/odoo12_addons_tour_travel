...
class TtRefund(models.Model):
    ...
    def get_refund_admin_fee_rule(self, agent_id, refund_type='regular', ho_id=False, customer_parent_id=False, provider_type_id=False):
                ...
                if order_type == 'airline':
                    ...
                    for rec in book_obj.provider_booking_ids:
                        for rec2 in rec.journey_ids:
                            journey_amount += 1
        admin_fee_obj = self.get_refund_admin_fee_rule(agent_id, refund_type, customer_parent_id=customer_parent_id, provider_type_id=provider_type_id)
