...
class ReservationPpob(models.Model):
    ...
    def _prepare_booking_api(self, data, context):
        ...
        provider_vals = {
            ...
            'registration_date': util.get_without_empty(data, 'registration_date') and datetime.strptime(data['registration_date'], '%Y%m%d') or False,
            ...
            'bill_expired_date': util.get_without_empty(data, 'bill_expired_date') and datetime.strptime(data['bill_expired_date'], '%Y%m%d') or False,
        ...
        for rec in data['bill_data']:
            ...
            bill_vals = {
                ...
                'period': util.get_without_empty(rec, 'period') and datetime.strptime(rec['period'], '%Y%m') or False,
                ...
                'period_end_date': util.get_without_empty(rec, 'period_end_date') and datetime.strptime(rec['period_end_date'], '%d%m%Y') or False,
                'meter_read_date': util.get_without_empty(rec, 'meter_read_date') and datetime.strptime(rec['meter_read_date'], '%d%m%Y') or False,
