    ...
    def _prepare_booking_api(self, data, context):
        ...
        for rec in data['bill_data']:
            ...
            bill_vals = {
                ...
                'period_end_date': int(util.get_without_empty(rec, 'period_end_date')) and datetime.strptime(rec['period_end_date'], '%d%m%Y') or False,
                'meter_read_date': int(util.get_without_empty(rec, 'meter_read_date')) and datetime.strptime(rec['meter_read_date'], '%d%m%Y') or False,
