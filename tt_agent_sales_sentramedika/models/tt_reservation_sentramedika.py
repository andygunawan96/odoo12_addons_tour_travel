...
class ReservationSentraMedika(models.Model):
    ...
    _inherit = 'tt.reservation.sentramedika'
    ...
    invoice_line_ids = fields.One2many('tt.agent.invoice.line', 'res_id_resv', 'Invoice',
                                       domain=[('res_model_resv', '=', 'tt.reservation.sentramedika')])
    ...
    def action_reverse_sentramedika(self,context):
        super(ReservationSentraMedika, self).action_reverse_sentramedika(context)
        for rec in self.invoice_line_ids:
            try:
    ...
    def action_issued_sentramedika(self,co_uid,customer_parent_id,acquirer_id):
        super(ReservationSentraMedika, self).action_issued_sentramedika(co_uid,customer_parent_id)
