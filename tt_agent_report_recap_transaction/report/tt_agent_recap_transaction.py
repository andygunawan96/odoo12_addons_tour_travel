...
class AgentReportRecapTransacion(models.Model):
    ...
    def _select():
        return """
            ...
            rsv.total as grand_total, rsv.total_commission, rsv.total_nta, rsv.provider_name as provider_name, rsv.create_date,
    ...
    @staticmethod
    def _order_ticket_number():
        return """
                , ticket_obj.ticket_number
                """
    ...
    def _lines_join_psg_ticket(self, date_from, date_to, agent_id, ho_id, customer_parent_id, provider_type, state, currency_id):
        ...
        if provider_type in ['airline', 'train']:
            query += self._order_ticket_number()
