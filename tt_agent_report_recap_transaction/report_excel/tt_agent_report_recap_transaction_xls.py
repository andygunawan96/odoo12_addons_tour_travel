        ...
        for idx, i in enumerate(datas):
            ...
            if i.get('ledger_pnr'):
                ...
                if temp_order_number == i['order_number']:
                    ...
                    sheet.write(row_data, incr.generate_number(), upsell, sty_amount) ### IVAN 22 dec 2022 untuk data lama upsell tidak masuk ke komisi data baru upsell sudah masuk ke komisi
                    if values['data_form']['is_ho']:
