...
class TransportJourney(models.Model):
    _name = 'tt.tb.journey.airline'
    _rec_name = 'pnr'
    # _order = 'sequence'
    _order = 'departure_date'

    provider_booking_id = fields.Many2one('tt.tb.provider.airline', 'Provider Booking', ondelete='cascade')
    ...
    segment_ids = fields.One2many('tt.tb.segment.airline', 'journey_id', 'Segments')
