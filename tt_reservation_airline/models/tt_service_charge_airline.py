...
class TtServiceChargeAirline(models.Model):
    ...
    passenger_airline_ids = fields.Many2many('tt.reservation.passenger.airline', 'tt_reservation_airline_cost_charge_rel', 'service_charge_id', 'passenger_id', 'Passenger Airline')