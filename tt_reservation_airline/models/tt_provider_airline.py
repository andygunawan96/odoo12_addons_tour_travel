...
class TtProviderAirlinePricing(models.Model):
    ...
    def compute_raw_data(self):
        ...
        provider_data = data['provider_pricing_data']
        agent_data = data['agent_pricing_data']
        customer_data = data['customer_pricing_data']
        agent_com_data = data['agent_commission_data']
