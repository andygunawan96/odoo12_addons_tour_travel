...
class ReservationAirline(models.Model):
    ...
    def create_refund_airline_api(self, data, context):
        try:
            ...
            admin_fee_obj = self.env['tt.refund'].get_refund_admin_fee_rule(airline_obj.agent_id.id, ref_type, customer_parent_id=customer_parent_id, provider_type_id=provider_type_id)
            if ref_type == 'quick':
