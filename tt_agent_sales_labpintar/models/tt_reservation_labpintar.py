...
class ReservationLabPintar(models.Model):
    ...
    _inherit = 'tt.reservation.labpintar'
    ...
    def action_reverse_labpintar(self,context):
        super(ReservationLabPintar, self).action_reverse_labpintar(context)
        for rec in self.invoice_line_ids:
            try:
    ...
    def action_issued_labpintar(self,co_uid,customer_parent_id,acquirer_id):
        super(ReservationLabPintar, self).action_issued_labpintar(co_uid,customer_parent_id)
