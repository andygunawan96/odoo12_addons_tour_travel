...
class ReservationReportAirlineXls(models.TransientModel):
    ...
    def _print_report_excel(self, data):
        ...
        sheet.write('M9', 'Origin', style.table_head_center)
        sheet.write('N9', 'Origin Country', style.table_head_center)
        ...
        for i in datas:
            ...
            if airline_number != i['airline_number']:
                ...
                sheet.write(row_data, 13, i['departure_country'], sty_table_data)
