...
class TtServiceChargeEvent(models.Model):
    ...
    passenger_event_ids = fields.Many2many('tt.reservation.passenger.event', 'tt_reservation_event_cost_charge_rel', 'service_charge_id', 'passenger_id', 'Passenger Event')