...
class ReservationMedical(models.Model):
    ...
    _inherit = 'tt.reservation.medical'
    ...
    invoice_line_ids = fields.One2many('tt.agent.invoice.line', 'res_id_resv', 'Invoice',
                                       domain=[('res_model_resv', '=', 'tt.reservation.medical')])
    ...
    def action_reverse_medical(self,context):
        super(ReservationMedical, self).action_reverse_medical(context)
        for rec in self.invoice_line_ids:
            try:
    ...
    def action_issued_medical(self,co_uid,customer_parent_id,acquirer_id):
        super(ReservationMedical, self).action_issued_medical(co_uid,customer_parent_id)
