...
class TtCustomer(models.Model):
    ...
    def to_dict(self):
        ...
        res = {
            ...
            'nationality_code': self.nationality_id.code and self.nationality_id.name or '',
            'country_of_issued': self.country_of_issued_id and self.country_of_issued_id.name or '',
