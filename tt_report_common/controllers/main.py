...
class Main(http.Controller):
    @http.route('/rodextrip/report/<string:print_type>/<string:model_name>/<int:model_id>', methods=['GET'], csrf=False, type='http', auth="public", website=True)
    def print_id(self, print_type, model_name, model_id):
