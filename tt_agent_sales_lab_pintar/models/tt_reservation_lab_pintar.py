...
class ReservationLabPintar(models.Model):
    ...
    _inherit = 'tt.reservation.lab.pintar'
    ...
    def action_reverse_lab_pintar(self,context):
        super(ReservationLabPintar, self).action_reverse_lab_pintar(context)
        for rec in self.invoice_line_ids:
            try:
    ...
    def action_issued_lab_pintar(self,co_uid,customer_parent_id,acquirer_id):
        super(ReservationLabPintar, self).action_issued_lab_pintar(co_uid,customer_parent_id)
