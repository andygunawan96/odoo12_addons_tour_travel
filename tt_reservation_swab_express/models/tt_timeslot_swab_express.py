...
class TtTimeslotSwabExpress(models.Model):
    _name = 'tt.timeslot.swab.express'
    ...
    booking_ids = fields.Many2many('tt.reservation.swab.express','tt_reservation_swab_express_timeslot_rel', 'timeslot_id', 'booking_id', 'Selected on By Customer Booking(s)')

    antigen_price_ids = fields.Many2many('tt.price.list.swab.express','tt_price_list_swab_express_price_antigen_rel','timeslot_antigen_id', 'price_list_id', 'Antigen')

    pcr_price_ids = fields.Many2many('tt.price.list.swab.express','tt_price_list_swab_express_price_pcr_rel','timeslot_pcr_id', 'price_list_id', 'PCR')

    pcr_priority_price_ids = fields.Many2many('tt.price.list.swab.express','tt_price_list_swab_express_price_pcr_priority_rel','timeslot_pcr_priority_id', 'price_list_id', 'PCR Priority')
    ...
    booking_used_ids = fields.One2many('tt.reservation.swab.express','picked_timeslot_id', 'Confirmed to Customer Booking(s)')
    ...
    def create(self, vals_list):
        vals_list['seq_id'] = self.env['ir.sequence'].next_by_code('tt.timeslot.swab.express')
    ...
    def get_config_cron(self):
        result = self.env['tt.swab_express.api.con'].get_config_cron()
        return result
...
class TtTimeslotswabexpressdefault(models.Model):
    _name = 'tt.timeslot.swab.express.default'
    ...
    antigen_price_ids = fields.Many2many('tt.price.list.swab.express', 'tt_price_list_swab_express_price_antigen_default_rel',
                                         'timeslot_antigen_id', 'price_list_id', 'Antigen')

    pcr_price_ids = fields.Many2many('tt.price.list.swab.express', 'tt_price_list_swab_express_price_pcr_default_rel',
                                     'timeslot_pcr_id', 'price_list_id', 'PCR')

    pcr_priority_price_ids = fields.Many2many('tt.price.list.swab.express',
                                              'tt_price_list_swab_express_price_pcr_priority_default_rel',
