...
class Reservationphc(models.Model):
    ...
    def print_eticket(self, data, ctx=None):
        ...
        datas['form'] = res
        medical_ticket_id = self.env.ref('tt_report_common.action_report_printout_reservation_phc')
    ...
    def print_itinerary(self, data, ctx=None):
        ...
        datas['form'] = res
        datas['is_with_price'] = True
        medical_ticket_id = book_obj.env.ref('tt_report_common.action_printout_itinerary_phc')
