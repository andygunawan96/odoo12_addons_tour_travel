...
class ServiceChargeVisa(models.Model):
    ...
    passenger_visa_ids = fields.Many2many('tt.reservation.visa.order.passengers', 'tt_reservation_visa_charge_rel', 'service_charge_id', 'passenger_id', 'Passenger Visa', readonly=False)
