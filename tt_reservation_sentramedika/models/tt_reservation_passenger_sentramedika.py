...
class TtReservationCustomer(models.Model):
    _name = 'tt.reservation.passenger.sentramedika'
    _inherit = 'tt.reservation.passenger'
    _description = 'Reservation Passenger Sentra Medika'

    cost_service_charge_ids = fields.Many2many('tt.service.charge','tt_reservation_sentramedika_cost_charge_rel', 'passenger_id', 'service_charge_id', 'Cost Service Charges')

    channel_service_charge_ids = fields.Many2many('tt.service.charge','tt_reservation_sentramedika_channel_charge_rel', 'passenger_id', 'service_charge_id', 'Channel Service Charges')

    booking_id = fields.Many2one('tt.reservation.sentramedika', 'Booking')
