...
class ReservationSentraMedika(models.Model):
    ...
    def action_issued_sentramedika(self, co_uid, customer_parent_id, acquirer_id = False):
    ...
    def action_issued_api_sentramedika(self,acquirer_id,customer_parent_id,context):
        self.action_issued_sentramedika(context['co_uid'],customer_parent_id,acquirer_id)
    ...
    def check_provider_state(self,context,pnr_list=[],hold_date=False,req={}):
        ...
        if all(rec.state == 'issued' for rec in self.provider_booking_ids):
            ...
            self.action_issued_api_sentramedika(acquirer_id and acquirer_id.id or False, customer_parent_id, context)
