...
class ReservationMitraKeluarga(models.Model):
    ...
    def action_issued_mitrakeluarga(self,co_uid,customer_parent_id,acquirer_id):
        super(ReservationMitraKeluarga, self).action_issued_mitrakeluarga(co_uid,customer_parent_id)
