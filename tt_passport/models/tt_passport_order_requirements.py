...
class PassportOrderRequirements(models.Model):
    _name = 'tt.passport.order.requirements'

    requirement_id = fields.Many2one('tt.passport.requirements', 'Requirement', readonly=1)
    to_passenger_id = fields.Many2one('tt.passport.order.passengers', 'Passenger', readonly=1)
