...
class AccGenerateCSVWizard(models.TransientModel):
    ...
    def generate_report_csv(self):
        ...
        for rec in queue_list:
            ...
            if rec_dict not in dupe_check_list:
                dupe_check_list.append(rec_dict)
                ...
                if data_dict.get('passenger_pricings'):
                    for pax in data_dict['passenger_pricings']:
                        for pax_pnr in pax['pnr_list']:
                            final_list.append({
                                ...
                                'discount': pax_pnr['discount'],
                                'parent_agent_commission': pax_pnr['parent_agent_commission'],
                    ...
                    final_list.append({
                        ...
                        'parent_agent_commission': data_dict.get('parent_agent_commission', 0),
