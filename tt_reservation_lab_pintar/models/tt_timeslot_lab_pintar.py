...
class TtTimeslotLabPintar(models.Model):
    ...
    booking_ids = fields.Many2many('tt.reservation.lab.pintar','tt_reservation_lab_pintar_timeslot_rel', 'timeslot_id', 'booking_id', 'Selected on By Customer Booking(s)')

    antigen_price_ids = fields.Many2many('tt.price.list.lab.pintar','tt_price_list_lab_pintar_price_antigen_rel','timeslot_antigen_id', 'price_list_id', 'Antigen')
    ...
    booking_used_ids = fields.One2many('tt.reservation.lab.pintar','picked_timeslot_id', 'Confirmed to Customer Booking(s)')
    ...
    def create(self, vals_list):
        vals_list['seq_id'] = self.env['ir.sequence'].next_by_code('tt.timeslot.lab.pintar')
    ...
    def get_config_cron(self):
        result = self.env['tt.lab_pintar.api.con'].get_config_cron()
        return result
...
class TtTimeslotlabpintardefault(models.Model):
    _name = 'tt.timeslot.lab.pintar.default'
    ...
    antigen_price_ids = fields.Many2many('tt.price.list.lab.pintar', 'tt_price_list_lab_pintar_price_antigen_default_rel',
