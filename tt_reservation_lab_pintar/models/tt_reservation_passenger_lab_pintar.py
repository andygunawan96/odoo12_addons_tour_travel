...
class TtReservationCustomer(models.Model):
    _name = 'tt.reservation.passenger.lab.pintar'
    _inherit = 'tt.reservation.passenger'
    _description = 'Reservation Passenger Lab Pintar'

    cost_service_charge_ids = fields.Many2many('tt.service.charge','tt_reservation_lab_pintar_cost_charge_rel', 'passenger_id', 'service_charge_id', 'Cost Service Charges')

    channel_service_charge_ids = fields.Many2many('tt.service.charge','tt_reservation_lab_pintar_channel_charge_rel', 'passenger_id', 'service_charge_id', 'Channel Service Charges')

    booking_id = fields.Many2one('tt.reservation.lab.pintar', 'Booking')
